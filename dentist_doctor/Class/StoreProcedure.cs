...
namespace dentist_doctor
{
    public static class StoreProcedure
    {
        ...
        public static void sp_insert_teeth(DataTable dt,int cus_id)
        {
            try
            {
                ...
                {
                    con.Open();
                    SqlCommand cmd = new SqlCommand("insert_teeth", con);
                    cmd.CommandType = CommandType.StoredProcedure;
            ...
            {
                GlobalMethod.HandleException("StoreProcedure / Insert Teeth : " + e.Message);
            }

            
        }
        public static DataTable get_teeth(int user_id)
        {
            try
            {
            ...
            catch (Exception e)
            {
                ...
                GlobalMethod.HandleException("StoreProcedure / get_teeth: " + e.Message);
                return null;
            }
        }
    }
